...
//++ p11309 - 2013.08.04 for Slim Sensor Config for Board version.
#if (CONFIG_BOARD_VER > CONFIG_WS20 ) 
	{
		...
		.reserved[0]     = 1,   /* T8_RESERVED_1 */      		
		.reserved[1]     = 1,   /* T8_RESERVED_2 */      		
		.reserved[2]     = 1,   /* T8_RESERVED_3 */   
		.refmode		 = 0,
	},
	{
		.chrgtime        = 80,  /* T8_CHRGTIME */
...
static proci_stylus_t47_config_t obj_stylus_t47[TOUCH_MODE_MAX_NUM] = {
	{	// Mode 0
		...
		.contmax    = 80,  /* T47_CONTMAX */					
		.stability  = 24, /* T47_STABILITY */					
		.maxtcharea = 3,   /* T47_MAXTCHAREA */          		
		.amplthr    = 30,  /* T47_AMPLTHR */					
		.styshape   = 12,  /* T47_STYSHAPE */					
...
static touch_multitouchscreen_t100_config_t obj_multi_touch_t100[TOUCH_MODE_MAX_NUM] = {
	{	// Mode 0
		.ctrl         = 131,   /* T100_CTRL */
		.cfg1         = 48,   /* T100_CFG1 */
		.scraux       = 2,	   /* T100_SCRAUX */
		.tchaux       = 28,	   /* T100_TCHAUX */
