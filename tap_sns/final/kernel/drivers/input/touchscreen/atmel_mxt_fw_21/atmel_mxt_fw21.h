...
#define MXT_CURRENT_FW_VERSION	0x05
#define MXT_CURRENT_FW_BUILD	  0xE2//0x0A
unsigned char MXT_FW21_E_firmware[] = {
#include "./firmware/mXT641T_V0.5.E2_.h"
};
...
#define MXT_CURRENT_FW_VERSION	0x10
#define MXT_CURRENT_FW_BUILD	  0xE1
unsigned char MXT_FW21_E_firmware[] = {
#include "./firmware/mXT641T_Production_V1.0.E1_021814_.h"
};

#endif

#define MXT_FW21_MAX_CHANNEL_NUM	640
...
#ifdef _MXT_641T_
#define MXT_T100_SCREEN_MESSAGE_NUM_RPT_ID	42 //46
#define MXT_T100_SCREEN_MSG_FIRST_RPT_ID	  40 //44
#else
...
#ifdef _MXT_641T_
#define MXT_FW21_I2C_BOOT_ADDR  0x26
#else
...
#ifdef _MXT_641T_
	{(int16_t*)&noisesuppression_t72_config.reserved_9[0], UINT8},
	{(int16_t*)&noisesuppression_t72_config.reserved_9[1], UINT8},
	{(int16_t*)&noisesuppression_t72_config.reserved_9[2], UINT8},
	{(int16_t*)&noisesuppression_t72_config.reserved_9[3], UINT8},
	{(int16_t*)&noisesuppression_t72_config.reserved_9[4], UINT8},
#endif
};
